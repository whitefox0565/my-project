...
public interface IBoardService {
	public List<BoardVO> getBoards(String ctg, @Param("offset") int offset, @Param("limit") int limitm, ArrayList<String> gymNameList); //페이징
	public int getTotalBoardCount(@Param("ctg") String ctg, ArrayList<String> gymNameList); // 전체 게시글양 가져오기
